                    ...
                    <div class="col-lg-6 col-sm-6 sx-product-images">
                        ...
                        <div class="thumbnail relative margin-bottom-3">
                            ...
                            <figure id="zoom-primary" class="zoom" data-mode="mouseover" style="position: relative; overflow: hidden;">
                                ...
                                <a class="sx-fancybox-gallary" style="display: none;" data-fancybox-group="gallery" href="<?= $model->image->src; ?>" title="<?=$model->image->name; ?>"></a>

                                <img src="/img/loader/loader-2.GIF" class="img-responsive sx-lazy" data-original="<?= $model->image->src ?>" title="<?= $model->name; ?>" alt="<?= $model->name; ?>" width="1200">
                        ...
                        <div data-for="zoom-primary" class="zoom-more owl-carousel owl-padding-3 featured sx-thumbnail" data-plugin-options='{"singleItem": false, "autoPlay": false, "navigation": true, "pagination": false, "items": 4, "progressBar":"false"}' style="opacity: 1; display: block;">
                                ...
                                <? foreach ($gallery as $image) : ?>
                                    <a class="sx-fancybox-gallary" style="display: none;" data-fancybox-group="gallery" href="<?= $image->src; ?>" title="<?=$image->name; ?>"></a>
...
JS
                        ...
                        <div class="shop-item-price">
                            <? if ($offer) : ?>
                                ...
                                <? else : ?>
                                    <span class="line-through nopadding-left"><?= \Yii::$app->money->convertAndFormat($offer->shopProduct->baseProductPrice->money); ?></span>
                                    <div class="sx-discount-price"><?= \Yii::$app->money->convertAndFormat($offer->shopProduct->minProductPrice->money); ?></div>
                                <? endif; ?>
                        ...
                        <div class="clearfix margin-bottom-30">
                            ...
                            <? if ($brand && $brand->image) : ?>
                                <span class="pull-right text-danger"><img src="<?= $brand->image->src?>" style="max-height: 80px; max-width: 180px;"></span>
                            <? endif; ?>
                            <!--
                            <span class="pull-right text-danger"><i class="glyphicon glyphicon-remove"></i> Out of Stock</span>
                            -->

                            <p><strong>Артикул:</strong> <?= $model->relatedPropertiesModel->getSmartAttribute('stockSaleId'); ?></p>
...
-->
                            <? if ($model->relatedPropertiesModel->getAttribute('composition')) : ?>
                                <p><strong>Состав:</strong> <?= $model->relatedPropertiesModel->getAttribute('composition'); ?></p>
                            <? endif; ?>
                            <? if ($model->relatedPropertiesModel->getAttribute('brand')) : ?>
                                <p><strong>Бренд:</strong> <?= $model->relatedPropertiesModel->getSmartAttribute('brand'); ?></p>
                            <? endif; ?>
                            <? if ($model->relatedPropertiesModel->getAttribute('season')) : ?>
                                <p><strong>Сезон:</strong> <?= $model->relatedPropertiesModel->getSmartAttribute('season'); ?></p>
                            <? endif; ?>
                        </div>
                        ...
                        <? if ($shopCmsContentElement->shopProduct->product_type == \skeeks\cms\shop\models\ShopProduct::TYPE_OFFERS) : ?>
                            ...
                            <form class="offers-form form" data-pjax>
                                ...
                                <? if ($selectData) : ?>
                                    ...
                                    <a class="btn btn-default btn-primary product-add-cart noradius" href="#" onclick="sx.Shop.addProduct($('#sx-offer').val(), 1); return false;"><i class="fa fa-cart-plus"></i> В корзину</a>
                                    <br />
