                        ...
                        <? foreach(\Yii::$app->shop->shopFuser->shopBaskets as $shopBasket) : ?>
                            ...
                            <div class="item">
                                <div class="cart_img pull-left width-100 padding-10 text-left">
                                        ...
                                        <img src="/img/loader/loader-2.GIF" data-original="<?= \skeeks\cms\helpers\Image::getSrc(
                                            \Yii::$app->imaging->getImagingUrl($shopBasket->image->src, new \skeeks\cms\components\imaging\filters\Thumbnail([
                                                'h' => 100,
                                                'w' => 100,
                                            ]))
                                        )?>"  class="sx-lazy" alt="<?=$shopBasket->name;?> title="<?=$shopBasket->name;?> width="80" />
                                </div>
