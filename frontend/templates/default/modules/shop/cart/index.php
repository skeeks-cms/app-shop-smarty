                        ...
                        <? foreach (\Yii::$app->shop->cart->shopBaskets as $shopBasket) : ?>
                            ...
                            <div class="item">
                                <div class="cart_img pull-left width-100 padding-10 text-left">
                                    <img
                                        src="<?= \skeeks\cms\helpers\Image::getSrc($shopBasket->product->cmsContentElement->image->src) ?>"
                                        alt="" width="80"/>
                                </div>
                ...
                <div class="toggle-transparent toggle-bordered-full clearfix">
                    <div class="toggle active" style="display: block;">
                        <div class="toggle-content" style="display: block;">
                            ...
                            <span class="clearfix">
                                <span
                                    class="pull-right"><?= \Yii::$app->money->intlFormatter()->format(\Yii::$app->shop->cart->moneyNoDiscount); ?></span>
                                <strong class="pull-left">Итого:</strong>
                            </span>
                            <span class="clearfix">
                                <span
                                    class="pull-right"><?= \Yii::$app->money->intlFormatter()->format(\Yii::$app->shop->cart->moneyDiscount); ?></span>
                                <span class="pull-left">Скидка:</span>
                            </span>
                            <span class="clearfix">
                                <span
                                    class="pull-right"><?= \Yii::$app->money->intlFormatter()->format(\Yii::$app->shop->cart->moneyDelivery); ?></span>
                            ...
                            <span class="clearfix">
                                <span
                                    class="pull-right size-20"><?= \Yii::$app->money->intlFormatter()->format(\Yii::$app->shop->cart->money); ?></span>
