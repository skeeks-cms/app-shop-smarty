    ...
    <div class="shop-item">
        ...
        <div class="thumbnail catalog_list">
            ...
            <div class="shop-option-over"><!-- replace data-item-id width the real item ID - used by js/view/demo.shop.js -->
                <a class="btn btn-default" data-pjax="0" href="<?= $model->url; ?>"><i class="fa fa-cart-plus size-20"></i></a>
            </div>
            <!-- /hover buttons -->
                ...
                <!-- price -->
                    <div class="shop-item-price">
                        ...
                        <? else : ?>
                            ...
                            <span class="sx-discount-price"><?= \Yii::$app->money->convertAndFormat($shopProduct->minProductPrice->money); ?></span>
                        <? endif; ?>
